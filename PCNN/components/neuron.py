...
class Neuron:
    ...
    def __init__(self, **kwargs):
        ...
        self.j = kwargs.get('j')
        # Scalar parameters
        self.yx = kwargs['yf'] if 'yf' in keys else np.float16(0.1)
        ...
        self.vt = kwargs['vt'] if 'vt' in keys else np.float16(10)
        ...
        # Matricies
        self.stimulus = 10 * self.prev_row.neuron_arr[self.i, self.j]
